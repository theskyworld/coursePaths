<template>
    <div>
        ...
        <div class="todo-list">
            <li>
                <label :for="id" class="todo">
                    <!-- checkbox -->
                    <input :id="id" class="todo__state" type="checkbox" />
                    <!-- 修饰线条 -->
                    ...
                    <!-- <button class="removeBtn" @click="$emit('remove')">remove</button> -->
                </label>
            </li>
...
<style scoped>
@import url("../styles/TodoListItem.css");
</style>